...
# Download 2017-06 data and add to main data
print("Getting 2017-06 data from repository")
download.file("https://github.com/MEF-BDA503/pj18-istema/blob/master/odd_car_sales_data_jun_17.rds?raw=true",destfile=tmprds)
main_data <- bind_rows(main_data,readRDS(tmprds))
