...
# Download 2017-07 data and add to main data
print("Getting 2017-07 data from repository")
download.file("https://github.com/MEF-BDA503/pj18-baysalu/blob/master/files/odd_retail_sales_2017_07.xlsx?raw=true",destfile=tmprds)
main_data <- bind_rows(main_data,readRDS(tmprds))
